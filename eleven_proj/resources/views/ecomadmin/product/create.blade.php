            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('product.store')}}"  method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Input Product Name</label>
                            <div class="col-md-9">
                                <input class="form-control" name="name"  placeholder="Product Name" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label"> Input Product Code</label>
                            <div class="col-md-9">
                                <input class="form-control" name="code"  placeholder="Product Code" type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="lastName" class="col-md-3 form-label">Input Product Stock</label>
                            <div class="col-md-9">
