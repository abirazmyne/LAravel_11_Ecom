                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    @foreach($product->otherImages as $otherimage)
                                        <div class="col-xl-3 col-lg-4 col-md-8 col-sm-12 card border-1 border-primary m-2  ">
                                            <img class="img-fluid" src="{{asset($otherimage->image)}}"   alt=""  style="max-width: 200px;">
                                        </div>
                                    @endforeach
                                </div>
