...
<div id="global-loader">
    <img src="{{asset('/')}}website/assets/img/banglabazar/titel-icon.png" class="loader-img" height="100px" alt="Loader">
</div>
<!-- /GLOBAL-LOADER -->
            ...
            <div class="app-sidebar">
                <div class="side-header">
                    <a class="header-brand1" href="{{route('admin.dashboard')}}">
                        ...
                        <img src="{{asset('/')}}website/assets/img/banglabazar/titel-icon.png" class="header-brand-img desktop-logo" alt="logo">
                        <img src="{{asset('/')}}website/assets/img/banglabazar/titel-icon.png" class="header-brand-img toggle-logo" alt="logo">
                        <img src="{{asset('/')}}website/assets/img/banglabazar/titel-icon.png" class="header-brand-img light-logo" alt="logo">
                        <img src="{{asset('/')}}website/assets/img/logo/logome.png" class="header-brand-img light-logo1" alt="logo">
                    </a><!-- LOGO -->
                </div>
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="1slider.add')}}" class="slide-item">Add Slider</a></li>
                                <li><a href="1slider.manage')}}" class="slide-item">Manage Sliders</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="1courier.add')}}" class="slide-item">Add Courier</a></li>
                                <li><a href="1courier.manage')}}" class="slide-item">Manage Courier</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="1admin-order.all')}}" class="slide-item">Orders</a></li>
        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                <div class="col-md-12 col-sm-12 text-center">
                    Copyright © 2024 <a href="#">Banglabazar</a>. Collaboration with <a href="#"> Abir Azmyne </a> All rights reserved
                </div>
            </div>
        </div>
    </footer>
...
<script>
    ...
    function getSubCategoryByCategory(categoryId) {
        $.ajax({
            type: "GET",
            url:"{{route('getSubCategory_ByCategory')}}",
            data: {id: categoryId},
            DataType: "JSON",
